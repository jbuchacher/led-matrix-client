...
// shamefully stolen from https://stackoverflow.com/a/34142316
    ...
    override func draw(_ rect: CGRect) {
        ...
        for y in stride(from: (0 as CGFloat), to: rect.height, by: elementSize) {
            ...
            for x in stride(from: (0 as CGFloat), to: rect.width, by: elementSize) {
                ...
                context.setFillColor(_ : color.cgColor)
                context.fill(_: CGRect(x:x, y:y, width:elementSize,height:elementSize))
            }
        }
    }
